...
class FixSRD : public Fix {
 ...
 private:
  ...
  double cylr;		    // Radius of the Cylinder
  double clareForce;	    // Force on the SRD particles (to simulate Poiseuille Flow in a channel, etc).
  double spc;		    // srd_per_cell that is read in (cylinder)
  ...
  double collision_cyl_exact(double *, int, double *,
                              double *, double *, double *);
  void collision_wall_inexact(double *, int, double *, double *, double *);
  void collision_cyl_inexact(double *, int, double *, double *, double *);
  ...
  void noslip(double *, double *, double *, Big *, int,
              double *, double *,  double *);
  void noslip_cyl(double *, double *, double *, Big *, int,
              double *, double *,  double *);
